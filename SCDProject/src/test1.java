...
//		add(NewLabel);
	...
	getContentPane().add(chckbxMuslim);
		...
		else if(chckbxVegan.isSelected())
		{
			pref="Vegan";
		}
		else if(chckbxMuslim.isSelected())
		{
			pref="Halal";
		}
		...
		try{	
                    conn c = new conn();
                    String str = "INSERT INTO foodmenu values('"+passenger_no+"', '"+cancellation_no+"', '"+cancellation_date+"', '"+ticket_id+"', '"+pref+"')";
